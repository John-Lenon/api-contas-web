...
namespace Application.Services.Cobranca
{
    public class RegraDiaAtrasoAppService : ServiceAppBase<RegraDiaAtraso, IRegraDiaAtrasoRepository>, IRegraDiaAtrasoAppService
    {
        ...
        protected override Expression<Func<RegraDiaAtraso, bool>> GetExpressionDelete(int id) => x => x.Id == id;         

        protected override Expression<Func<RegraDiaAtraso, bool>> GetExpressionFilter(object filterBase)
        {
